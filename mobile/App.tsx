...
type Screen = 'home' | 'scanner' | 'members' | 'wallet' | 'notifications';
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.page}>
        ...
        <Action title="SCAN QR" copy="Check in with the camera and post attendance/CE to the same ICA record." primary onPress={() => setScreen('scanner')} />
